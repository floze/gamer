...
module Gamer
	...
	class<<self
		...
		def commands_for protocol
			return unless protocol
			cmnds = request_strings[protocol]
			raise_unhandled_protocol_exception(protocol) unless cmnds
			cmnds
		end
		
		def raise_unhandled_protocol_exception protocol
		...
		def load options = Hash.new
			...
			load_request_strings_yaml
		end
		
		def load_request_strings_yaml
		...
		def constantize str
			return unless str
			protocol = request_strings[str]
			raise_unhandled_protocol_exception(str) unless protocol
			begin
